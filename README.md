...
**9B-MMX** 是一個高通量、製程感知的合金鑄造風險快篩原型，面向 **Fe-Mn-Cr-Ni-C-N** 等探索性結構合金搜尋空間。它會根據物理描述符與歷史/代理失敗資料，快速標記需要排除、人工審查，或送往 CALPHAD / 實驗規劃的候選，協助研究者決定哪些成分值得進一步投入資源。
...
**9B-MMX 目前較適合**用於「高碳/中碳 Fe-Mn-Cr-Ni-C-N 系統」的快速風險過濾。
...
如果你正在探索高強度或低溫結構合金的早期設計方向，9B-MMX 可作為其中一種啟發式風險標記工具。請務必參考驗證報告，並搭配 CALPHAD 與實驗來評估其適用性。
